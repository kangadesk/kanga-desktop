...
case $CHOICE in
        1)
            wget -O - "https://raw.githubusercontent.com/pilelu/mate-desktop/master/packages/install-control.sh" | sudo bash
            ;;
        2)
            wget -O - "https://raw.githubusercontent.com/pilelu/mate-desktop/master/packages/version-control.sh" | sudo bash
            ;;
        3)
            sudo raspi-config
            ;;
