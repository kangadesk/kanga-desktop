...
if grep -q "ImageDir=/usr/share/plymouth/themes/pix/splash.png" "$PP";
	then
		sudo sed -i -e "s/ImageDir=\/usr\/share\/plymouth\/themes\/pix\/splash.png/ImageDir=\/opt\/kangadesk\/splash.png/g" "$PP"
	else
		echo "Doing Nothing"
fi
#
